...
CREATE TABLE "Connection" (
    ...
    "fromOuput" TEXT NOT NULL DEFAULT 'main',
...
-- CreateIndex
CREATE UNIQUE INDEX "Connection_fromNodeId_fromOuput_toNodeId_toInput_key" ON "Connection"("fromNodeId", "fromOuput", "toNodeId", "toInput");
